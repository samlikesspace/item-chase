...
execute if score stage rushDB matches 2 if score item rushDB matches 1 run titleraw @a[tag="runner"] actionbar {"rawtext":[{"text":"APPLE  §l§a"},{"selector": "@a[tag=runner]"},{"text":" §r§o§7(you)§r§7  §a"},{"selector": "@a[tag=hunter]"}]}
